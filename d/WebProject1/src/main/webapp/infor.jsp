...
<body>
	...
	<br>
	<div class="container">
		<form method="post" action="inforUpdate">
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title"><span class="glyphicon glyphicon-tags"></span>&nbsp;&nbsp;나의 가입 정보</h3>
				</div>
				<div class="panel-body text-center">
					<br>
					<span style="font-size: 20px; color: #000000;">아이디&nbsp;</span> <input type="text" class="form-control center-block"  style="width: 60%;" id="ID" name="ID" disabled="disabled" value="${USER_ID}">
					<div id="idcheck"><span style="color: blue;">아이디 변경은 불가합니다</span></div>
					<br>
					<span style="font-size: 20px; color: #000000;">비밀번호&nbsp;</span> <input type="password" class="form-control center-block" placeholder="비밀번호를 입력해주세요" style="width: 60%;" id="pwd1" name="PW" value="${USER_PW}">
					...
					<br>
					<span style="font-size: 20px; color: #000000;">비밀번호 확인&nbsp;</span> <input type="password" class="form-control center-block" placeholder="비밀번호를 한번 더 입력해주세요" style="width: 60%;" id="pwd2" name="PW2" value="${USER_PW}">
					...
					<br>
					<span style="font-size: 20px; color: #000000;">이름&nbsp;</span> <input type="text" class="form-control center-block" placeholder="이름을 입력해주세요" style="width: 60%;" id="" name="NAME" value="${USER_NAME}">
					<div id="namecheck"><span style="color: green;">id/pw찾기에 이름이 활용됩니다</span></div>
					<br>
					<span style="font-size: 20px; color: #000000;">이메일&nbsp;</span> <input type="text" class="form-control center-block" placeholder="이메일을 입력해주세요" style="width: 60%;" id="EMAIL" name="EMAIL" value="${USER_EMAIL}">
				...
				<div class="panel-footer">
					<div class="row text-center">
						<span style="color:#aaa;"><button type="submit" class="btn btn-success" id="userSubmit"><span class="glyphicon glyphicon-ok">&nbsp;정보수정</span></button></span>
					</div>
				</div>
			</div>
		</form>
